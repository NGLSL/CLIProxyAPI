...
// Each CodexKey entry produces exactly one Auth record using its single APIKey.
func (s *ConfigSynthesizer) synthesizeCodexKeys(ctx *SynthesisContext) []*coreauth.Auth {
	...
	for i := range cfg.CodexKey {
		...
		// DisableCooling metadata: when true, the scheduler skips cooldown for this auth.
