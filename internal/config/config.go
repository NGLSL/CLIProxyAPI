...
import (
	...
	sdkpluginstore "github.com/NGLSL/CLIProxyAPI/v7/sdk/pluginstore"
...
type PluginsConfig struct {
	...
	// StoreAuth 定义插件商店 registry、metadata、artifact 请求的可选鉴权规则。
...
type CodexConfig struct {
	// IdentityConfuse remaps Codex request identifiers per selected auth when routing keeps requests on a stable auth.
